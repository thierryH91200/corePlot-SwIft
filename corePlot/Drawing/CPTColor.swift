...
class CPTColor: NSObject {
    ...
    static let sharde = CPTColor()
    
    var nsColorCache : NSUIColor?
    var nativeColor : NSUIColor?
    
    override init()
    {
//        self.initWithComponentRed(0.0 green:0.0 blue:0.0 alpha:0.0)
    }


//    func colorWithGenericGray( gray: CGFloat)
//    {
//        var values   = [ gray, gray, gray, CGFloat(1.0) ]
//
//        let colorRef = CGColorCreate([CPTColorSpace genericRGBSpace].cgColorSpace, values);
//        let color     =  init(colorRef: CGColor)
//
//    }
    ...
    //
    //
    //    let values = [CGFloat(0.0), CGFloat(0.0), CGFloat(0.0), CGFloat(0.0)]
    //
    //
    ...
    //
    //var color: CPTColor? = {
    //    var if let clear = clear {
    //        color = self.init(cgColor: clear)
    //    }
    //    return color
    //}()
    //
